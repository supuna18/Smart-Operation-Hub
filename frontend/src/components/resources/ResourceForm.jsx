                        ...
                        <div className="space-y-10">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            <select
                                                ...
                                                value={formData.type}
                                                onChange={handleChange}
                                                className="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 appearance-none focus:ring-4 focus:ring-yellow-500/10 focus:border-yellow-400 transition-all outline-none font-bold text-sm shadow-inner-sm cursor-pointer"
                                            >
                            ...
                            <section className="space-y-5">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        <label className="block text-[11px] font-black text-slate-400 uppercase tracking-[0.15em] mb-2 px-1 text-xs">Availability Window</label>
                                        <div className="relative group">
                                            <input
                                                type="text"
